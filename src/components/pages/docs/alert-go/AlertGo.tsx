  ...
  return (
    <div className="max-w-4xl pb-24 p-6">
      ...
      <Description className="mt-2">
        ...
        анимации, действия и TypeScript. Работает с React, Next.js, Vite и любыми сборщиками.
      </Description>
      ...
      <div className="mt-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-300">
          <li>API как у <code>sonner</code> — <code>toast()</code>, <code>toast.success()</code> и т.д.</li>
          <li>Поддержка 6 позиций: <code>top-left</code>, <code>top-center</code>, <code>bottom-right</code> и др.</li>
          <li>Анимации, соответствующие позиции — сверху, снизу, слева, справа</li>
      ...
      <div className="mt-10">
        ...
        <Description className="mt-3">
          <strong>1. Подключение стилей</strong> — обязательно в <code>app/layout.tsx</code>:
        </Description>
        ...
        <Description className="mt-3 text-sm text-gray-400">
          ⚠️ Стили подключаются только через <code className="bg-[#303030] px-1 rounded">import &quot;alert-go/dist/notifier.css&quot;</code> — не в компонентах!
        </Description>
      </div>
      ...
      <div className="mt-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-300 mt-2">
          <li><code>toast(message, options)</code> — обычное уведомление</li>
          <li><code>toast.success(message, options)</code> — уведомление об успехе</li>
          <li><code>toast.error(message, options)</code> — уведомление об ошибке</li>
          <li><code>toast.warning(message, options)</code> — предупреждение</li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-300 mt-2">
        <li><code>position: &apos;top-left&apos; | &apos;top-center&apos; | &apos;top-right&apos; | &apos;bottom-left&apos; | &apos;bottom-center&apos; | &apos;bottom-right&apos;</code> — позиция уведомления</li>
        <li><code>duration?: number</code> — время до авто-скрытия (в мс, по умолчанию 3000)</li>
          <li><code>actionText?: string</code> — текст кнопки действия</li>
          <li><code>onAction?: () =&gt; void</code> — колбэк при нажатии на кнопку</li>
        </ul>
      </div>
...
.notify.default {
  background: #2c3e50 !important;
        ...
        <Description className="mt-3 text-sm text-gray-400">
          💡 Используйте <code>!important</code>, если оригинальные стили перекрываются.
        </Description>
      </div>
      ...
      <div className="mt-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-300 mt-2">
          ...
          <li><strong>Фреймворки:</strong> работает без React (чистый DOM API)</li>
        </ul>
      </div>
    </div>
  );
