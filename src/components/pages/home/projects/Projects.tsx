			...
			<div className="container">
				<div className="pb-8 flex justify-between flex-col md:flex-row items-start">
					<div className="w-full max-w-[550px]">
						...
						<Description>
							Наши npm-библиотеки созданы для разработчиков, которые ценят
							чистый код, гибкость и быстрое внедрение. Каждая библиотека легко
							устанавливается, настраивается и интегрируется в ваши проекты на
							React и Next.js.
						</Description>
					</div>
